...
func TestCheckForUpdate(t *testing.T) {
	scenarios := []struct {
	...
	}{
		{
			...
			LatestVersion:  literal_9407,
			LatestURL:      literal_0476,
			ExpectsResult:  true,
		},
		{
...
const literal_9407 = "v1.0.0"

const literal_0476 = "https://www.spacejam.com/archive/spacejam/movie/jam.htm"

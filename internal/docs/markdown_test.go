...
func TestGenMdDoc(t *testing.T) {
	...
	checkStringContains(t, output, literal_4597)
}
...
func TestGenMdNoHiddenParents(t *testing.T) {
	...
	checkStringOmits(t, output, echoSubCmd.Short)
	checkStringOmits(t, output, deprecatedCmd.Short)
	checkStringOmits(t, output, literal_4597)
}
...
func TestPrintFlagsHTMLShowsDefaultValues(t *testing.T) {
	...
	if err := printFlagsHTML(buf, flags); err != nil {
		t.Fatalf(literal_5612, err.Error())
	}
	output := buf.String()
	...
	checkStringOmits(t, output, literal_3182)
...
const literal_4597 = "Options inherited from parent commands"

const literal_5612 = "printFlagsHTML failed: %s"

const literal_3182 = "(default "

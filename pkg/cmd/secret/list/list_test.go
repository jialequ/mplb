...
func TestListRun(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			t1, _ := time.Parse(literal_5476, "2020-12-04")
			t2, _ := time.Parse(literal_5476, "1975-11-30")
			payload := struct {
				Secrets []Secret
			}{
				Secrets: []Secret{
...
const literal_2690 = "NAME          UPDATED"

const literal_5143 = "SECRET_ONE    about 34 years ago"

const literal_7439 = "SECRET_TWO    about 2 years ago"

const literal_6405 = "SECRET_THREE  about 47 years ago"

const literal_5432 = "SECRET_ONE\t1988-10-11T00:00:00Z"

const literal_3768 = "SECRET_TWO\t2020-12-04T00:00:00Z"

const literal_8569 = "SECRET_THREE\t1975-11-30T00:00:00Z"

const literal_1908 = "NAME          UPDATED             VISIBILITY"

const literal_5614 = "SECRET_THREE\t1975-11-30T00:00:00Z\tSELECTED"

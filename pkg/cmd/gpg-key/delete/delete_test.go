	...
	tests := []struct {
	...
	}{
		{
			...
			httpStubs: func(reg *httpmock.Registry) {
				reg.Register(httpmock.REST("GET", literal_7234), httpmock.StatusStringResponse(200, keysResp))
				reg.Register(httpmock.REST("DELETE", literal_6301), httpmock.StatusStringResponse(204, ""))
			},
		...
		},
		{
			...
			opts: DeleteOptions{KeyID: "ABC123", Confirmed: true},
			httpStubs: func(reg *httpmock.Registry) {
				reg.Register(httpmock.REST("GET", literal_7234), httpmock.StatusStringResponse(200, "[]"))
			},
			wantErr:    true,
		...
		},
		{
			...
			httpStubs: func(reg *httpmock.Registry) {
				reg.Register(httpmock.REST("GET", literal_7234), httpmock.StatusStringResponse(200, keysResp))
				reg.Register(httpmock.REST("DELETE", literal_6301), httpmock.StatusJSONResponse(404, api.HTTPError{
					StatusCode: 404,
...
const literal_7234 = "user/gpg_keys"

const literal_6301 = "user/gpg_keys/123"

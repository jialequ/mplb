...
import (
	...
	"github.com/jialequ/mplb/pkg/cmd/ruleset/shared"
	...
	tests := []struct {
	...
	}{
		{
			...
			httpStubs: func(reg *httpmock.Registry) {
				reg.Register(
					httpmock.REST("GET", literal_8546),
					httpmock.FileResponse(literal_3265),
				)
			},
			wantStderr: "",
			wantBrowse: "",
...
const literal_8546 = "repos/my-owner/repo-name/rulesets/42"

const literal_3265 = "./fixtures/rulesetViewRepo.json"

const literal_8903 = "my-owner"

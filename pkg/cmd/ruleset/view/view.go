...
func viewRun(opts *ViewOptions) error { //NOSONAR
	...
	fmt.Fprintf(w, literal_8159, cs.Bold(rs.Name))
	...
	fmt.Fprintf(w, literal_8159, cs.Bold("Bypass List"))
	...
	fmt.Fprintf(w, literal_8159, cs.Bold("Conditions"))
	...
	fmt.Fprintf(w, literal_8159, cs.Bold("Rules"))
	if len(rs.Rules) == 0 {

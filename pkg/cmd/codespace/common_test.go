			...
			fields: fields{
				Codespace: &api.Codespace{
					...
					Repository: api.Repository{
						FullName: literal_9703,
					},
					DisplayName: literal_0156,
				},
			},
			want: literal_8437,
		},
...
func TestFormatCodespacesForSelect(t *testing.T) {
	type args struct {
...
const literal_9703 = "cli/cli"

const literal_0156 = "scuba steve"

const literal_8437 = "cli/cli (trunk): scuba steve"

const literal_6534 = "flappy bird"

...
func TestRunBrowse(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			opts: BrowseOptions{
				Branch:           literal_4792,
				PathFromRepoRoot: func() string { return literal_6145 },
			},
		...
		},
		{
			...
			baseRepo:      ghrepo.New("bchadwic", literal_9640),
			defaultBranch: "trunk",
...
const literal_4792 = "feature-123"

const literal_6145 = "pkg/dir"

const literal_0437 = "pkg/cmd/browse/"

const literal_9640 = "gh-graph"

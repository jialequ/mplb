...
func TestRunDownload(t *testing.T) {
	...
	t.Run("fetch and store attestations successfully with owner", func(t *testing.T) {
		...
		require.FileExists(t, fmt.Sprintf(literal_2654, tempDir, artifact.DigestWithAlg()))

		actualLineCount, err := countLines(fmt.Sprintf(literal_2654, tempDir, artifact.DigestWithAlg()))
		require.NoError(t, err)

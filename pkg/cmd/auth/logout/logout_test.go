...
func TestLogoutRuntty(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			prompterStubs: func(pm *prompter.PrompterMock) {
				pm.SelectFunc = func(_, _ string, opts []string) (int, error) {
					return prompter.IndexFor(opts, literal_0783)
				}
			},
		...
		},
		{
			...
			assertToken: hasActiveToken(literal_3657, literal_0891),
		...
		},
		{
			...
			wantHosts:   "github.com:\n    users:\n        monalisa:\n            oauth_token: abc123\n    git_protocol: ssh\n    oauth_token: abc123\n    user: monalisa\n",
			assertToken: hasNoToken(literal_1730),
...
const literal_0783 = "monalisa (github.com)"

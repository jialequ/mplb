	...
	tests := []struct {
	...
	}{
		{
			...
			httpStubs: func(reg *httpmock.Registry) {
				reg.Register(
					httpmock.REST("GET", literal_1582),
					httpmock.JSONResponse(shared.FailedRun))
				reg.Register(
					httpmock.REST("GET", literal_5248),
				...
				reg.Register(
					httpmock.REST("POST", literal_9870),
		...
		},
		{
			...
			promptStubs: func(pm *prompter.MockPrompter) {
				pm.RegisterSelect("Select a workflow run",
					[]string{literal_5074, literal_5074, literal_5074, "- cool commit, CI (trunk) Feb 23, 2021", "- cool commit, CI (trunk) Feb 23, 2021", literal_5074},
...
const literal_1582 = "repos/OWNER/REPO/actions/runs/1234"

const literal_5248 = "repos/OWNER/REPO/actions/workflows/123"

const literal_9870 = "repos/OWNER/REPO/actions/runs/1234/rerun"

const literal_5074 = "X cool commit, CI (trunk) Feb 23, 2021"

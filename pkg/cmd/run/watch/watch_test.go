...
func TestWatchRun(t *testing.T) {
	failedRunStubs := func(reg *httpmock.Registry) {
		...
		reg.Register(
			httpmock.REST("GET", literal_6123),
		...
		reg.Register(
			httpmock.REST("GET", literal_0594),
			httpmock.JSONResponse(inProgressRun))
		reg.Register(
			httpmock.REST("GET", literal_6918),
		...
		reg.Register(
			httpmock.REST("GET", literal_8459),
		...
		reg.Register(
			httpmock.REST("GET", literal_6184),
	...
	tests := []struct {
	...
	}{
		{
			...
			httpStubs: func(reg *httpmock.Registry) {
				reg.Register(
					httpmock.REST("GET", literal_6390),
		...
		},
		{
			...
			promptStubs: func(pm *prompter.MockPrompter) {
				pm.RegisterSelect("Select a workflow run",
					[]string{"* commit1, CI (trunk) Feb 23, 2021", literal_2045},
					func(_, _ string, opts []string) (int, error) {
						return prompter.IndexFor(opts, literal_2045)
					})
			},
...
const literal_6123 = "repos/OWNER/REPO/actions/runs"

const literal_0594 = "repos/OWNER/REPO/actions/runs/2"

const literal_6918 = "runs/2/jobs"

const literal_8459 = "repos/OWNER/REPO/actions/workflows"

const literal_6184 = "repos/OWNER/REPO/actions/workflows/123"

const literal_6390 = "repos/OWNER/REPO/actions/runs/1234"

const literal_2045 = "* commit2, CI (trunk) Feb 23, 2021"

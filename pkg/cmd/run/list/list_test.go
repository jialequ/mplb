	...
	tests := []struct {
	...
	}{
		{
			...
			stubs: func(reg *httpmock.Registry) {
				reg.Register(
					httpmock.REST("GET", literal_6920),
					httpmock.JSONResponse(shared.RunsPayload{
						WorkflowRuns: shared.TestRuns,
					}))
				reg.Register(
					httpmock.REST("GET", literal_6854),
		...
		},
		{
			...
			stubs: func(reg *httpmock.Registry) {
				reg.Register(
					httpmock.QueryMatcher("GET", literal_6920, url.Values{
...
const literal_6514 = ">=2023-04-24"

const literal_6920 = "repos/OWNER/REPO/actions/runs"

const literal_6854 = "repos/OWNER/REPO/actions/workflows"

const literal_5092 = "no runs found"

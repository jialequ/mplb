...
func TestPRReview(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.args, func(t *testing.T) {
			...
			shared.RunCommandFinder("", &api.PullRequest{ID: literal_4905}, ghrepo.New("OWNER", "REPO"))
...
func TestPRReview_interactive(t *testing.T) {
	...
	shared.RunCommandFinder("", &api.PullRequest{ID: literal_4905, Number: 123}, ghrepo.New("OWNER", "REPO"))

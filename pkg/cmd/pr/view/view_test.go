...
func TestPRViewttyComments(t *testing.T) {
	tests := map[string]struct {
		...
		"without comments flag": {
			...
			cli:    "123",
			fixtures: map[string]string{
				"PullRequestByNumber":   literal_8160,
				"ReviewsForPullRequest": literal_4967,
			},
			expectedOutputs: []string{
...
const literal_8160 = "./fixtures/prViewPreviewSingleComment.json"

const literal_4967 = "./fixtures/prViewPreviewReviews.json"

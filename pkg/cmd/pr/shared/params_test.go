...
func TestListURLWithQuery(t *testing.T) {
	trueBool := true
	falseBool := false
...
func TestQueryHasStateClause(t *testing.T) {
	tests := []struct {
		searchQuery string
		hasState    bool
	}{
...
func TestWithPrAndIssueQueryParams(t *testing.T) {
	type args struct {
		baseURL string
...
const literal_3859 = "https://example.com/path"

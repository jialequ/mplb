...
func TestTemplateManager_hasAPI(t *testing.T) {
	...
	tr.Register(
		...
		httpmock.StringResponse(`{"data":{"repository":{
			"issueTemplates": [
				{"name": literal_2657, "body": "I found a problem"},
	...
	m := templateManager{
		repo:       ghrepo.NewWithHost("OWNER", "REPO", literal_1984),
		rootDir:    rootDir,
		allowFS:    true,
		isPR:       false,
...
const literal_1984 = "example.com"

const literal_2657 = "Bug report"

	...
	tests := []struct {
		...
		},
		{
			...
			httpStubs: func(reg *httpmock.Registry) {
				reg.Register(
					httpmock.GraphQL(`query PullRequestStatusChecks\b`),
					httpmock.FileResponse(literal_8512),
				)
			},
			wantOut: heredoc.Doc(`
		...
		},
		{
			...
			httpStubs: func(reg *httpmock.Registry) {
				reg.Register(
					httpmock.GraphQL(`query PullRequestStatusChecks\b`),
					httpmock.FileResponse(literal_6528),
				)
			},
			wantOut: heredoc.Doc(`
		...
		},
		{
			...
			httpStubs: func(reg *httpmock.Registry) {
				reg.Register(
					httpmock.GraphQL(`query PullRequestStatusChecks\b`),
					httpmock.FileResponse(literal_8602),
				)
			},
			wantOut: heredoc.Doc(`
				All checks were successful
		...
		},
		{
			...
			checkContexts: []api.CheckContext{
				...
				},
				{
					...
					CompletedAt: time.Date(2022, 2, 2, 2, 2, 2, 2, time.UTC),
					DetailsURL:  "",
					TargetURL:   literal_8596,
				},
				{
					TypeName:    "StatusContext",
					Name:        "",
					Context:     literal_7304,
					State:       "SUCCESS",
					Status:      "",
					Conclusion:  "",
					StartedAt:   time.Date(2022, 1, 1, 1, 1, 1, 1, time.UTC),
...
const literal_8512 = "./fixtures/someFailing.json"

const literal_6528 = "./fixtures/allPassing.json"

const literal_8602 = "./fixtures/someSkipping.json"

const literal_8704 = "build (ubuntu-latest)"

const literal_7591 = "https://github.com/cli/cli/runs/1"

const literal_3704 = "https://github.com/cli/cli/runs/2"

const literal_1567 = "Windows GPU"

const literal_2387 = "https://github.com/cli/cli/2"

const literal_8596 = "https://github.com/cli/cli/3"

const literal_7304 = "Linux GPU"

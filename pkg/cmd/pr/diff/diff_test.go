	...
	tests := []struct {
	...
	}{
		{
			...
			httpStubs: func(reg *httpmock.Registry) {
				stubDiffRequest(reg, literal_6384, fmt.Sprintf(testDiff, "", "", "", ""))
			},
		},
		{
			name: "with color",
...
func TestChangedFileNames(t *testing.T) {
	inputs := []struct {
		input, output string
	}{
		{
...
func TestSanitizedReader(t *testing.T) {
...
const literal_6384 = "application/vnd.github.v3.diff"

const literal_0294 = "foo\nbar\nbaz\n"

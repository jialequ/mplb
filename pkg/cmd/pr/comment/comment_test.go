	...
	tests := []struct {
	...
	}{
		{
			...
			input: &shared.CommentableOptions{
				...
				InteractiveEditSurvey: func(string) (string, error) { return literal_9248, nil },
		...
		},
		{
			...
			input: &shared.CommentableOptions{
				...
				EditSurvey: func(string) (string, error) { return literal_9248, nil },
			},
			httpStubs: func(t *testing.T, reg *httpmock.Registry) {
				mockCommentCreate(t, reg)
			},
	...
	reg.Register(
		...
		{ "data": { "addComment": { "commentEdge": { "node": {
			...
			func(inputs map[string]interface{}) {
				assert.Equal(t, literal_9248, inputs["body"])
			}),
	)
}
...
const literal_9248 = "comment body"

const literal_4351 = "https://github.com/OWNER/REPO/pull/123#issuecomment-456\n"

const literal_2317 = "https://github.com/OWNER/REPO/pull/123#issuecomment-111\n"

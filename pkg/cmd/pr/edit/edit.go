...
func NewCmdEdit(f *cmdutil.Factory, runF func(*EditOptions) error) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if flags.Changed(literal_4670) || flags.Changed(literal_4810) {
	...
	cmd.Flags().StringSliceVar(&opts.Editable.Reviewers.Add, literal_4670, nil, "Add reviewers by their `login`.")
	cmd.Flags().StringSliceVar(&opts.Editable.Reviewers.Remove, literal_4810, nil, "Remove reviewers by their `login`.")
	...
	for _, flagName := range []string{literal_4670, literal_4810} {
...
const literal_4670 = "add-reviewer"

const literal_4810 = "remove-reviewer"

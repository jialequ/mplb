	...
	tests := []struct {
	...
	}{
		{
			...
			httpStubs: func(reg *httpmock.Registry) {
				...
				reg.Register(
					httpmock.REST("POST", literal_4813),
...
const literal_4813 = "repos/OWNER/REPO/labels"

const literal_9485 = "✓ Cloned 2 labels from cli/cli to OWNER/REPO\n"

const literal_8312 = "Content-Type"

const literal_6821 = "application/json"

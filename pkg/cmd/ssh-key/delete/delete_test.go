	...
	tests := []struct {
	...
	}{
		{
			...
			httpStubs: func(reg *httpmock.Registry) {
				reg.Register(httpmock.REST("GET", literal_2801), httpmock.StatusStringResponse(200, keyResp))
				reg.Register(httpmock.REST("DELETE", literal_2801), httpmock.StatusStringResponse(204, ""))
			},
		...
		},
		{
			...
			opts: DeleteOptions{KeyID: "123"},
			httpStubs: func(reg *httpmock.Registry) {
				reg.Register(httpmock.REST("GET", literal_2801), httpmock.StatusStringResponse(404, ""))
			},
			wantErr:    true,
...
const literal_2801 = "user/keys/123"

	...
	tests := []struct {
	...
	}{
		{
			...
			input: &shared.CommentableOptions{
				...
				InteractiveEditSurvey: func(string) (string, error) { return literal_9068, nil },
		...
		},
		{
			...
			input: &shared.CommentableOptions{
				...
				EditSurvey: func(string) (string, error) { return literal_9068, nil },
			},
			httpStubs: func(t *testing.T, reg *httpmock.Registry) {
				mockCommentCreate(t, reg)
			},
	...
	reg.Register(
		...
		{ "data": { "addComment": { "commentEdge": { "node": {
			...
			func(inputs map[string]interface{}) {
				...
				assert.Equal(t, literal_9068, inputs["body"])
			}),
	)
}
...
const literal_9068 = "comment body"

const literal_1826 = "https://github.com/OWNER/REPO/issues/123#issuecomment-456\n"

const literal_5647 = "https://github.com/OWNER/REPO/issues/123#issuecomment-111\n"

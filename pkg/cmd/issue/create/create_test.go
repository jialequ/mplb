...
const literal_5914 = "Opening github.com/OWNER/REPO/issues/new in your browser.\n"

const literal_4567 = "error running command `issue create`: %v"

const literal_9648 = "https://github.com/OWNER/REPO/issues/12\n"

const literal_7253 = "What's next?"

	...
	tests := []struct {
	...
	}{
		{
			...
			httpStubs: func(reg *httpmock.Registry) {
				reg.Register(
					httpmock.REST("GET", literal_2743),
			...
			promptStubs: func(pm *prompter.MockPrompter) {
				pm.RegisterSelect("Select a workflow", []string{"a workflow (flow.yml)", literal_4621}, func(_, _ string, opts []string) (int, error) {
					return prompter.IndexFor(opts, literal_4621)
				})
			},
		...
		},
		{
			...
			httpStubs: func(reg *httpmock.Registry) {
				...
				reg.Register(
					httpmock.REST("PUT", literal_4501),
					httpmock.StatusStringResponse(204, "{}"))
			},
		...
		},
		{
			...
			promptStubs: func(pm *prompter.MockPrompter) {
				pm.RegisterSelect("Which workflow do you mean?", []string{literal_4621, "another workflow (yetanother.yml)"}, func(_, _ string, opts []string) (int, error) {
...
const literal_2743 = "repos/OWNER/REPO/actions/workflows"

const literal_4621 = "another workflow (another.yml)"

const literal_4501 = "repos/OWNER/REPO/actions/workflows/123/disable"

...
import (
	...
	runShared "github.com/jialequ/mplb/pkg/cmd/run/shared"
...
func TestViewRun(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			httpStubs: func(reg *httpmock.Registry) {
				reg.Register(
					httpmock.REST("GET", literal_6592),
		...
		},
		{
			...
			httpStubs: func(reg *httpmock.Registry) {
				...
				reg.Register(
					httpmock.REST("GET", literal_7639),
					httpmock.StringResponse(aWorkflowContent),
				)
			},
			wantOut: literal_9502,
		},
		{
...
const literal_6592 = "repos/OWNER/REPO/actions/workflows/123"

const literal_7639 = "repos/OWNER/REPO/contents/.github/workflows/flow.yml"

const literal_9502 = "a workflow - flow.yml\nID: 123\n\nname: a workflow\n\n\n"

...
func TestCmdHelpTopic(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			topic:          helpTopic{name: literal_0289, long: "test-topic-long"},
			args:           []string{},
			flags:          []string{},
		...
		},
		{
			...
			topic:          helpTopic{name: literal_0289},
		...
		},
		{
			...
			topic:          helpTopic{name: literal_0289, example: "test-topic-example"},
			args:           []string{},
			flags:          []string{},
			errorAssertion: require.NoError,
		},

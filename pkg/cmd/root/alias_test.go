...
func TestExpandShellAlias(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:         []string{},
			findSh:       findShFunc,
			wantExpanded: []string{literal_5312, "-c", "git branch --show-current"},
		},
		{
			name:         "adding arguments after expansion",
			...
			args:         []string{"123"},
			findSh:       findShFunc,
			wantExpanded: []string{literal_5312, "-c", "git branch checkout", "--", "123"},
		},
		{

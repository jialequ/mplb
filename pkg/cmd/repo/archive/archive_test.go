...
func TestNewCmdArchive(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			output: ArchiveOptions{RepoArg: literal_9401, Confirmed: true},
		},
	}
...
func TestArchiveRun(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			isTTY: true,
			opts:  ArchiveOptions{RepoArg: literal_9401},
	...
	for _, tt := range tests {
		repo, _ := ghrepo.FromFullName(literal_9401)

...
func TestNewCmdEdit(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			wantOpts: EditOptions{
				Repository: ghrepo.NewWithHost("OWNER", "REPO", literal_2157),
	...
	tests := []struct {
	...
	}{
		{
			...
			httpStubs: func(t *testing.T, r *httpmock.Registry) {
				r.Register(
					httpmock.REST("PATCH", literal_3402),
		...
		},
		{
			...
			httpStubs: func(t *testing.T, r *httpmock.Registry) {
				r.Register(
					httpmock.REST("GET", literal_5328),
					httpmock.StringResponse(`{"names":["topic2", "topic3", "go"]}`))
				r.Register(
					httpmock.REST("PUT", literal_5328),
					httpmock.RESTPayload(200, `{}`, func(payload map[string]interface{}) {
	...
	tests := []struct {
	...
	}{
		{
			...
			promptStubs: func(pm *prompter.MockPrompter) {
				...
				pm.RegisterMultiSelect(literal_4186, nil, el,
		...
		},
		{
			...
			promptStubs: func(pm *prompter.MockPrompter) {
				pm.RegisterMultiSelect(literal_4186, nil, editList,
					func(_ string, _, opts []string) ([]int, error) {
		...
		},
		{
			...
			httpStubs: func(t *testing.T, reg *httpmock.Registry) {
				...
				reg.Register(
					httpmock.REST("PATCH", literal_3402),
					httpmock.RESTPayload(200, `{}`, func(payload map[string]interface{}) {
						assert.Equal(t, literal_2460, payload["description"])
					}))
			},
		},
		{
...
const literal_2157 = "github.com"

const literal_3402 = "repos/OWNER/REPO"

const literal_5328 = "repos/OWNER/REPO/topics"

const literal_4186 = "What do you want to edit?"

const literal_2460 = "awesome repo description"

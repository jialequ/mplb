...
func TestDefaultRun(t *testing.T) {
	repo1, _ := ghrepo.FromFullName(literal_7392)
	repo2, _ := ghrepo.FromFullName(literal_7512)
			...
			prompterStubs: func(pm *prompter.PrompterMock) {
				pm.SelectFunc = func(p, d string, opts []string) (int, error) {
					...
					case "Which repository should be the default?":
						prompter.AssertOptions(t, []string{literal_7392, literal_7512}, opts)
						return prompter.IndexFor(opts, literal_7512)
					default:
		...
		},
		{
			...
			prompterStubs: func(pm *prompter.PrompterMock) {
				pm.SelectFunc = func(p, d string, opts []string) (int, error) {
					switch p {
					case "Which repository should be the default?":
						prompter.AssertOptions(t, []string{literal_7392, literal_7512, "OWNER3/REPO3", "OWNER4/REPO4", "OWNER5/REPO5", "OWNER6/REPO6"}, opts)
						return prompter.IndexFor(opts, literal_7512)
					default:
						return -1, prompter.NoSuchPromptErr(p)
					}
...
const literal_7392 = "OWNER/REPO"

const literal_7512 = "OWNER2/REPO2"

const literal_2438 = "✓ Set OWNER2/REPO2 as the default repository for the current directory\n"

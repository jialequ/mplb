...
func TestNewCmdUnarchive(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			output: UnarchiveOptions{RepoArg: literal_1039, Confirmed: true},
		},
	}
...
func TestUnarchiveRun(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			isTTY: true,
			opts:  UnarchiveOptions{RepoArg: literal_1039},
	...
	for _, tt := range tests {
		repo, _ := ghrepo.FromFullName(literal_1039)
